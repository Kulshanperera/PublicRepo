...
<head>
  ...
  <link rel = "stylesheet"  type = "text/css" href = "homeCss.css" />
   <link rel = "stylesheet"  type = "text/css" href = "indextk.css" />
...
<center>
 <ul class="list-group list-group-flush">
    <li class="list-group-item active">  <a href="home" >HOME</a></li>
...
<table align="center" cellpadding= "15" class = "table3" style="margin-left:580px ;margin-right:auto;">
<thead>
	<tr>
...
<tr>
		<th><button type="" name="reset" value="Clear"/>EDIT</button></th>
		<th><button type="sumbit" name="reset" value="Home"/>DELETE</button></th>
	</tr>
	</thead>
